      ...
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="relative flex h-[324px] items-center justify-center">
            ...
            {/* Horizontal lines */}
            <div className="absolute inset-x-0 top-0 h-px -z-10 bg-gradient-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply"></div>
            <div className="absolute inset-x-0 bottom-0 h-px -z-10 bg-gradient-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply"></div>
